...
pub struct PostgresCommentAttachmentRepository {
    pool: Pool<Postgres>,
}

impl PostgresCommentAttachmentRepository {
    pub fn new(pool: Pool<Postgres>) -> Self {
        Self { pool }
    }

    fn map_record(row: PgRow) -> CommentAttachmentRecord {
...
#[async_trait]
impl CommentAttachmentRepository for PostgresCommentAttachmentRepository {
